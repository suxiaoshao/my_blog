<template>
    <div class="article_reply">
        <el-card shadow="hover">
            ...
            <div class="reply_post" v-loading="post_loading">
                ...
                <el-form :model="post_data" :rules="rules" ref="post_data">
                    <el-row :gutter="20">
                        ...
                        <el-col :sm="8" :xs="24">
                            <el-form-item prop="name">
                                <el-input maxlength="20" v-model="post_data.name" placeholder="名字(必填)"
                        ...
                        <el-col :sm="8" :xs="24">
                            <el-form-item prop="email">
                                <el-input maxlength="100" v-model="post_data.email" placeholder="邮箱(必填)"
                        ...
                        <el-col :sm="8" :xs="24">
                            <el-form-item prop="url">
                                <el-input maxlength="100" v-model="post_data.url" placeholder="网址(选填)"
                    ...
                    <el-form-item prop="content">
                        <el-input type="textarea" :autosize="{ minRows: 7, maxRows: 12}" placeholder="评论内容"
                                  v-model="post_data.content"></el-input>
                    </el-form-item>
            ...
            <!-- 评论翻页 -->
            <div class="block">
                <el-pagination :hide-on-single-page="true" @current-change="handleCurrentChange" :current-page="page"
                               :page-size="limit_num" layout="prev, pager, next,jumper" :total="reply_num"
                               :pager-count="5"
                ></el-pagination>
            </div>
        </el-card>
                ...
                this.axios
                    ...
                    .then(response => {
                        ...
                        if (response.data.success) {
                            ...
                            this.$emit("reply_num_update", response.data.reply_num);
                        ...
                        this.axios
                            ...
                            .then(response => {
                                ...
                                if (response.data.success) {
                                    ...
                                    this.$emit("reply_num_update", this.reply_num + 1); // 评论数加一
                                } else {
                                    this.post_loading = false;
                                    this.$notify({
                                        title: "错误",
